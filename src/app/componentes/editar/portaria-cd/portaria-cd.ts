...
import { TextoPortaria } from '../portaria-cdr/texto-portaria/texto-portaria';

@Component({
  selector: 'app-portaria-cd',
  imports: [
    CommonModule,
    FormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './portaria-cd.html',
  styleUrl: './portaria-cd.css',
})
export class PortariaCd {
