...
import {
  DadosResolucaoCdr,
  PrintResolucaoCdr,
} from '../resolucao-cdr/print-resolucao-cdr/print-resolucao-cdr';
...
@Component({
  ...
  templateUrl: './resolucao-cd.html',
  styleUrl: './resolucao-cd.css',
})
export class ResolucaoCd {
  sr: string = '';
